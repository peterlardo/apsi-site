export const SECTIONS = {
  ...
  skill_tags: ["Audit", "Pentest", "Conformité", "Formation", "Conseil"],
  why_choose: [
    {
      icon: "Users",
  ...
  projects: [
    { tag: "Secteur bancaire", title: "Audit de sécurité — Banque Nationale", text: "Audit complet des systèmes bancaires critiques", icon: "Landmark" },
    { tag: "E-commerce", title: "Pentest — Plateforme de paiement", text: "Tests d'intrusion sur la plateforme e-paiement", icon: "ShoppingCart" },
    { tag: "Télécommunications", title: "Conformité NIS2 — Opérateur mobile", text: "Mise en conformité réglementaire complète", icon: "Building2" },
    { tag: "Industrie", title: "Sécurisation — OT & systèmes industriels", text: "Protection des systèmes de contrôle industriels", icon: "Factory" },
  ],
  team: [
    {
      name: "Jean-Claude Mboungou",
      role: "Président — Expert sécurité",
  ...
  hero_slides: ["/hero-1.jpg", "/hero-2.jpg", "/hero-3.jpg", "/hero-4.jpg"],
  values: [
    {
      icon: "Target",
      title: "Notre mission",
  ...
  trainings: [
    { icon: "ShieldCheck", title: "Fondamentaux de la cybersécurité", text: "Initiation aux concepts essentiels : menaces, vulnérabilités, contrôles et bonnes pratiques de protection des systèmes d'information." },
    { icon: "Lock", title: "ISO 27001 & gestion des risques", text: "Mettre en place un SMSI conforme à l'ISO 27001 et piloter l'analyse des risques de sécurité de l'information." },
    { icon: "Bug", title: "Test d'intrusion & sécurité offensive", text: "Méthodologies de pentest, découverte de vulnérabilités applicatives et techniques de remédiation." },
    { icon: "Network", title: "Sécurité réseau & cloud", text: "Sécurisation des infrastructures, segmentation, durcissement et bonnes pratiques cloud (DevSecOps)." },
    { icon: "FileSearch", title: "Conformité RGPD / NIS2", text: "Comprendre les exigences légales applicables au Congo et en Afrique centrale, et les intégrer à vos projets." },
    { icon: "CloudCog", title: "Réponse aux incidents & SOC", text: "Mettre en place un SOC, détecter, analyser et répondre efficacement aux incidents de sécurité." },
  ],
  commissions: [
    { id: "formations-certifications", icon: "GraduationCap", title: "Commission Formations et certifications", text: "Programmes de montée en compétence, ateliers pratiques et accompagnement vers les certifications professionnelles reconnues en sécurité de l'information." },
    { id: "veille-recherches", icon: "Search", title: "Commission Veille et Recherches", text: "Surveillance des vulnérabilités émergentes, partage d'outils, retours d'expérience entre experts et publication de travaux de recherche." },
    { id: "plaidoyer-institutionnel", icon: "Handshake", title: "Commission Plaidoyer et relations institutionnelles", text: "Dialogue avec les institutions publiques et privées pour structurer la cybersécurité au niveau national et faire évoluer le cadre réglementaire." },
    { id: "innovation-projets", icon: "Lightbulb", title: "Commission Innovation et projets", text: "Conception et pilotage des projets innovants de l'association, des solutions concrètes au service de la sécurité numérique congolaise." },
    { id: "contentieux-conformite", icon: "Scale", title: "Commission Contentieux et Conformité", text: "Veille sur les cadres réglementaires (ANSSI, ISO 27001, NIS2, RGPD) et accompagnement des organisations congolaises vers la conformité." },
    { id: "communication-medias", icon: "Megaphone", title: "Commission Communication et Médias", text: "Campagnes de sensibilisation, présence médiatique et animation des réseaux de l'association pour informer le public sur les risques numériques." },
  ],
  events: [
    { icon: "Users", title: "Rencontres mensuelles", date: "Chaque 1er jeudi du mois", place: "Brazzaville", text: "Rencontres d'échange entre professionnels de la sécurité de l'information, partage de retours d'expérience et veille collective." },
    { icon: "Trophy", title: "Capture The Flag (CTF)", date: "Deux fois par an", place: "En ligne", text: "Compétitions pratiques de cybersécurité ouvertes aux étudiants et aux professionnels pour développer leurs compétences techniques." },
    { icon: "CalendarDays", title: "Conférence annuelle APSI-CG", date: "Chaque année", place: "Brazzaville", text: "Le rendez-vous de la cybersécurité au Congo : conférences, panels et ateliers avec des experts nationaux et internationaux." },
    { icon: "MapPin", title: "Ateliers de sensibilisation", date: "Tout au long de l'année", place: "Entreprises & écoles", text: "Campagnes de sensibilisation aux risques numériques destinées aux organisations, aux écoles et au grand public." },
  ],
  contact_cards: [
    { icon: "Mail", title: "Écrivez-nous", lines: ["contact@apsi-cg.org"], href: "mailto:contact@apsi-cg.org" },
    { icon: "Phone", title: "Appelez-nous", lines: ["+242 06 123 45 67", "+242 05 123 45 67"], href: "tel:+242061234567" },
    { icon: "MapPin", title: "Notre adresse", lines: ["Avenue Amílcar Cabral, Centre-ville", "Brazzaville, République du Congo"] },
...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1562813733-b31f71025d54?auto=format&fit=crop&w=900&q=80",
    body: "",
  },
];
